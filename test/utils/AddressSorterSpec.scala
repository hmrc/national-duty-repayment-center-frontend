...
class AddressSorterSpec extends FreeSpec with MustMatchers {
  ...
  "sorting a list of LookedUpAddress objects" - {
    ...
    "should sort a complex data set correctly" in {
      ...
      val addrs = List(
        ...
        LookedUpAddress(List("The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 1, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 1a-2a,Station Industrial Estat", "The Homend"),"ABC Town",Some("ABC County"), "ZZ99 1AA"),
        LookedUpAddress(List("Unit 3, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 3a, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 4", "Homend Trading Estate"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 4, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 4a, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 5, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 5a, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 6, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 6a", "Homend Trading Estate"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 6b, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 6c, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 7, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
        LookedUpAddress(List("Unit 7b, Station Industrial Estate", "The Homend"),"ABC Town",Some("ABC County"),"ZZ99 1AA")
      ).map(a => LookedUpAddressWrapper("id", Uprn(123456L), a, "en", Some(Location(0, 0))))
  ...
  "should sort another complex data set correctly" in {
    ...
    val addrs = List(
      ...
      LookedUpAddress(List("67a", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("67a", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Building B and B1,Bush Hill Park Pr", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Building C,Bush Hill Park Primary", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Building D,Bush Hill Park Primary", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Car Park, Wheatsheaf Hall", "121-123 Roman Way"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Classroom Building,Bush Hill Park", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      ...
      LookedUpAddress(List("Infant Building,Bush Hill Park Prim", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Land, Bush Hill Park Primary School", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Main Building,Bush Hill Park Primar", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Main Building, Wheatsheaf Hall", "121-123 Roman Way"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Nursery,Bush Hill Park Primary Scho", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Offices 1", "67A Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Progress Centre,Bush Hill Park Prim", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      ...
      LookedUpAddress(List("Reception,Bush Hill Park Primary Sc", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Store F,Bush Hill Park Primary Scho", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Store G,Bush Hill Park Primary Scho", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
      LookedUpAddress(List("Studio,Bush Hill Park Primary Schoo", "Main Avenue"),"ABC Town",Some("ABC County"),"ZZ99 1AA"),
