...
class UpscanNotificationFormatSpec extends SpecBase {

  "UpscanNotificationFormats" should {

    "serialize and deserialize UpscanFileReady" in new JsonFormatTest[UpscanNotification] {
      validateJsonFormat(
        """{
    ...
    "deserialize UpscanFileReady with encoded word" in new JsonFormatTest[UpscanNotification] {
      validateJsonReads(
        """{
          |"reference":"11370e18-6e24-453e-b45a-76d3e32ea33d",
          |"fileStatus":"READY",
    ...
    "serialize and deserialize UpscanFileFailed when QUARANTINE" in new JsonFormatTest[UpscanNotification] {
      validateJsonFormat(
    ...
    "serialize and deserialize UpscanFileFailed when REJECTED" in new JsonFormatTest[UpscanNotification] {
      validateJsonFormat(
    ...
    "serialize and deserialize UpscanFileFailed when UNKNOWN" in new JsonFormatTest[UpscanNotification] {
      validateJsonFormat(
    ...
    "deserialize UpscanFileReady with multiple encoded words" in new JsonFormatTest[UpscanNotification] {
      validateJsonReads(
        """{
          |"reference":"11370e18-6e24-453e-b45a-76d3e32ea33d",
          |"fileStatus":"READY",
