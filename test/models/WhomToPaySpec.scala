...
class WhomToPaySpec extends WordSpec with MustMatchers with ScalaCheckPropertyChecks with OptionValues {
  ...
  "WhomToPay" must {
    ...
    "fail to deserialise invalid values" in {
      ...
      val gen = arbitrary[String] suchThat (!WhomToPay.values.map(_.toString).contains(_))
