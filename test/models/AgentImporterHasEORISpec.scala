...
class AgentImporterHasEORISpec extends WordSpec with MustMatchers with ScalaCheckPropertyChecks with OptionValues {

  "AgentImporterHasEORI" must {
    ...
    "fail to deserialise invalid values" in {
      ...
      val gen = arbitrary[String] suchThat (!AgentImporterHasEORI.values.map(_.toString).contains(_))
