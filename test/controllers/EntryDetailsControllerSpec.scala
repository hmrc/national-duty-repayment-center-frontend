...
class EntryDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  val bulkFileUpload = routes.BulkFileUploadController.showFileUpload()
  ...
  "EntryDetails Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, NormalMode, bulkFileUpload)(fakeRequest, messages).toString
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(EntryDetails("123","123456Q", validDateAnswer)), NormalMode, bulkFileUpload)(fakeRequest, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, bulkFileUpload)(fakeRequest, messages).toString
