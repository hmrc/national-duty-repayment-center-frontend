...
trait ResaonForOverpaymentViewBehaviours extends QuestionViewBehaviours[String] {

  val answer = ClaimDescription("answer")

  def reasonForOverpaymentPage(form: Form[ClaimDescription],
                               createView: Form[ClaimDescription] => HtmlFormat.Appendable,
