...
class CheckYourAnswersHelper(userAnswers: UserAnswers)(implicit messages: Messages) {
  ...
  def article: Option[AnswerRow] = userAnswers.get(ArticlePage) map {
    x =>
      AnswerRow(
  ...
  def otherDutiesDueToHMRC: Option[AnswerRow] = userAnswers.get(OtherDutiesDueToHMRCPage) map {
    x =>
      AnswerRow(
        ...
        HtmlFormat.escape(x),
        routes.OtherDutiesDueToHMRCController.onPageLoad(CheckMode).url
      )
  }
  ...
  def otherDutiesPaid: Option[AnswerRow] = userAnswers.get(OtherDutiesPaidPage) map {
    x =>
      AnswerRow(
        ...
        HtmlFormat.escape(x),
        routes.OtherDutiesPaidController.onPageLoad(CheckMode).url
      )
  }
  ...
  def customsDutyDueToHMRC: Option[AnswerRow] = userAnswers.get(CustomsDutyDueToHMRCPage) map {
    x =>
      AnswerRow(
        ...
        HtmlFormat.escape(x),
        routes.CustomsDutyDueToHMRCController.onPageLoad(CheckMode).url
      )
  }
